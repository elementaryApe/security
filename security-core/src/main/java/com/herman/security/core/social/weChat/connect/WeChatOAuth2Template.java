...
public class WeChatOAuth2Template extends OAuth2Template {
    ...
    public WeChatOAuth2Template(String appId, String secret, String authorizeUrl, String accessTokenUrl) {
        super(appId, secret, authorizeUrl, accessTokenUrl);
    ...
    public AccessGrant exchangeForAccess(String authorizationCode,
                                         String redirectUri, MultiValueMap<String, String> additionalParameters) {
